...
The aerial surveys data includes NZ Imagery Surveys and NZ Elevation Surveys.
...
Elevation data available on the LDS is similarly made up of many different regions with separate elevation index tiles including limited metadata. The NZ Elevation Surveys dataset provides much more information about the elevation surveys in one location.
